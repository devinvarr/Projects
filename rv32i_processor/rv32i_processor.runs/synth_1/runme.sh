...
HD_PWD='C:/Users/Devin/Desktop/School/RISC/lab9/rv32i_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rv32_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rv32_top_level.tcl
