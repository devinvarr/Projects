...
HD_PWD='C:/Users/Devin/Desktop/School/RISC/lab9/rv32i_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rv32_top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rv32_top_level.tcl -notrace
